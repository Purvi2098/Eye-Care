...
if(isset($_POST["reset-password"]))
{
  ...
  if($row!=0)
  {
    ...
    {
      echo  "<b><font color='#FF0000'><script>alert('Sucessfully changed.')</script>";
    }
            ...
            <div class="section-field mb-20">
             ...
             <div class="section-field mb-20">
                <label class="mb-10" for="name">Old Password* </label>
                  <input id="member_password" class="web form-control" type="text"   placeholder="User password" name="member_password">
              </div>
             
              <div class="section-field mb-20">
              <label class="mb-10" for="Password">New Password* </label>
               <input id="confirm_password" class="Password form-control" type="password"  placeholder="New password" name="confirm_password">
              </div>
