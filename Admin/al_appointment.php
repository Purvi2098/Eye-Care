      ...
      <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h4> Are you sure, you want to Cancel appointment ??? </h4>
                      <div class="form-group pull-right">
                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">No</button>

                        <button type="submit" class="btn btn-outline-primary" name="Cancel_appointment">Yes!! Cancel it</button> 
                      </div>
...
<section class="content">
    ...
    <table id="appointTable" width="100%" class="table table-striped table-bordered table-hover">
        ...
        <?php
            ...
            $query=mysqli_query($conn,"SELECT appointment.Date,appointment.Time,appointment.PatientID,patient.PatientName,patient.MobileNo FROM appointment,patient WHERE appointment.PatientID=patient.PatientID;");
